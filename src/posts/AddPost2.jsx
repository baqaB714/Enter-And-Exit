...
import { setPostService , updatePostService } from '../services/PostServices';
            ...
            <div className="row justify-content-center mt-5 ">
                <form onSubmit={handleAddPost} className="col-12 col-md-6 bg-light rounded shadow-lg p-3">
                    <div className="mb-3">
                        ...
                        <select className="form-control" value={data.userId} onChange={(e)=>{setData({...data , userId:e.target.value}) ; console.log(e.target.value)}}>
